...
public class CreateRevenueRuleRequestValidator : AbstractValidator<CreateRevenueRuleRequest>
{
    public CreateRevenueRuleRequestValidator()
    {
        RuleFor(x => x.Type)
            .Must(t => t is "Project" or "ClientIncome" or "NetProfit")
            .WithMessage("Type must be 'Project', 'ClientIncome', or 'NetProfit'");
